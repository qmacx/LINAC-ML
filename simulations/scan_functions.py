...
def single_scan(x):
    ...
    for angle in x:
        string1 = "s/B1: CSRCSBEND,L=0.4,ANGLE=.*,E1=0.001,E2=0.001,N_SLICES=50,BINS=500,SG_HALFWIDTH=1/B1: CSRCSBEND,L=0.4,ANGLE={},E1=0.001,E2=0.001,N_SLICES=50,BINS=500,SG_HALFWIDTH=1/g".format(angle)
        os.system("sed -i '%s' XFELTransportLineFinal.lte"%(string1))
        string2 = "s/B4: CSRCSBEND,L=0.4,ANGLE=.*,E1=0.001,N_SLICES=50,BINS=500,SG_HALFWIDTH=1/B4: CSRCSBEND,L=0.4,ANGLE={},E1=0.001,N_SLICES=50,BINS=500,SG_HALFWIDTH=1/g".format(angle)
        os.system("sed -i '%s' XFELTransportLineFinal.lte"%(string2))
