...
hidden2 = tf.keras.layers.Dense(units=inputdims * 16, kernel_initializer=tf.keras.initializers.HeNormal(), activation='relu')(hidden1, training=True)
...
plt.ylabel('')
plt.legend()
plt.savefig('../plots/regression_uncertainty_none.png')
